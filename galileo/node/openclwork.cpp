...
__kernel void galileoblocks_work (__global ulong * attempt, __global ulong * result_a, __global uchar * item_a)
{
							...
							if (!error_a)
							{
								...
								if (!error_a)
								{
									...
									if (!error_a)
									{
										...
										kernel = clCreateKernel (program, "galileoblocks_work", &kernel_error);
