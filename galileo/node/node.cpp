...
lmdb_max_dbs (128)
{
	...
	switch (galileo::galileo_network)
	{
		...
		case galileo::galileo_networks::galileo_beta_network:
			preconfigured_peers.push_back ("galileo-beta.galileoblocks.net");
		...
		case galileo::galileo_networks::galileo_live_network:
			preconfigured_peers.push_back ("galileo.galileoblocks.net");
...
stats (config.stat_config)
{
	...
	BOOST_LOG (log) << "Node starting, version: " << GALILEO_VERSION_MAJOR << "." << GALILEO_VERSION_MINOR;
